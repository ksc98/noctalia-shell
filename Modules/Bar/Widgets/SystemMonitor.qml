    ...
    GridLayout {
      ...
      Item {
        ...
        GridLayout {
          ...
          // Compact mode general cpu (hide if cores or core chart is shown)
          Loader {
            active: compactMode && !showCpuCores && !showCpuCoreChart
            visible: compactMode && !showCpuCores && !showCpuCoreChart
